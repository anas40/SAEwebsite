        ...
        if (j.hasClass("fullscreen")) {
            ...
            function C(Q) {
                if (h) {
                    ...
                    b(Q).children().css({
                        top: (window.screen.availHeight - O / P) / 2
                    });
                    ...
                    i.append(b("<div id='container'/>").css({
                        "margin-top": (b(window).height() - O / P) / 2
                    }).append((b(Q).children().css({
                        width: O,
                        "max-width": "95%"
                    }))));
                    (function () {
            ...
            function r(i) {
                if (h) {
                    ...
                    b("#viewfullscreen>#container").children().css({
                        width: "",
                        "max-width": o
                    }).appendTo(b(i));
